...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mmulji-ic/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<BlogQueryAllCommentResponse, RpcStatus>({
      path: `/mmulji-ic/blog/blog/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mmulji-ic/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/mmulji-ic/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mmulji-ic/blog/blog/posts
   */
  queryPosts = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryPostsResponse, RpcStatus>({
      path: `/mmulji-ic/blog/blog/posts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
